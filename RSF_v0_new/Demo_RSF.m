...
c0 = 2;
imgID = 3; % 1,2,3,4,5,6  % choose one of the five test images
...
switch imgID
    case 1
        ...
        initialLSF = ones(size(Img(:,:,1))).*c0;
         initialLSF(50:60,50:60) = -c0;
%         initialLSF(20:70,60:90) = -c0;
    case 2
        iterNum =2000;
        lambda1 = 1.0;
        lambda2 = 1.0;
...
for n=1:iterNum
    u=RSF(u,I,K,KI,KONE, nu,timestep,mu,lambda1,lambda2,epsilon,1,sigma,n,temp);
    if mod(n,20)==0
        pause(0.1);
