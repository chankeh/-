function u = RSF(u0,Img,Ksigma,KI,KONE,nu,timestep,mu,lambda1,lambda2,epsilon,numIter,sigma,numIterNumber,temp)
...
for k1=1:numIter
    ...
    enegy1=(lambda1-lambda2)*KONE.*Img.*Img;
    enegy2=conv2(s1,Ksigma,'same');
    enegy3=-2.*Img.*conv2(s2,Ksigma,'same');
    dataForce=enegy1+enegy2+enegy3;
                                                        % eq.(15)
