...
c0 = 2;
imgID =1 ; % 1,2,3,4,5,6  % choose one of the five test images
...
switch imgID
    case 1
        ...
        lambda1 = 1.0;
        lambda2 = 1.0;
        nu = 0.0004*255*255;% coefficient of the length term
        initialLSF = ones(size(Img(:,:,1))).*c0;
%         initialLSF(20:60,20:30) = -c0;
        initialLSF(30:50,80:90) = -c0;
    case 2
        iterNum =2000;
        lambda1 = 1.0;
        lambda2 = 1.0;
        ...
        %initialLSF(1:ic,1:jc) = -c0;
        initialLSF(50:60,20:50) = -c0;
    case 3
        iterNum =300;
        lambda1 = 1.0;
        lambda2 = 1.0;
        ...
        initialLSF = ones(size(Img(:,:,1))).*c0;
%         initialLSF(50:60,20:90) = -c0;
        initialLSF(55:78,32:95) = -c0;
    case 4
        iterNum =1500;
        lambda1 = 1.0;
        lambda2 = 1.0;
...
sigma=10.0;    % scale parameter in Gaussian kernel
...
for n=1:iterNum
    u=OCLBF(u,I,K,KI,KONE, nu,timestep,mu,lambda1,lambda2,epsilon,1,sigma);
    if mod(n,20)==0
        pause(0.1);
